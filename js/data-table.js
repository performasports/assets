$(document).ready(function() {
  ...
  $(".kpi-category.one").find(".team-stats-secondary-heading-row").append("<div class='team-stats-data-row 1st-Half'>");
  $(".kpi-category.one").find(".team-stats-secondary-heading-row").append("<div class='team-stats-data-row 2nd-Half'>");
